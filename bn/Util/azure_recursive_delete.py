...
def recursive_delete(azure_dir_content, cache):
    ...
    present_working_dir = 'ProjectsData/'+'/'.join(cache)
    print(present_working_dir)
    ...
    return file_client.delete_directory('data', directory_name=present_working_dir)