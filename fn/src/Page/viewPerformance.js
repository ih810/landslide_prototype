  ...
  const handleModelStat = async () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        // accuracy
        setModelAccuracy(
          (parseFloat(tempModelStatistic.accuracy) * 100).toFixed(2)
        );
        // confusion matrix
  ...
  return (
    <>
      <StepNavBtn
        ...
        next={`/view-results/${props.match.params.project_name}`}
      />
      <Grid container sx={{ m: 3, ml: 14 }}>
          ...
          >
            ...
            <Grid item xs={12} sx={{ pb: 1 }}>
              ...
              >
                ...
                <TableContainer
                  sx={{ maxHeight: 400, width: "auto", maxWidth: "350" }}
                >
                                ...
                                >
                                  ...
                                  {metricsRow[""] === "Support" ? (
                                    ...
                                    <>
                                      <TableCell align="right">
                                        {(
                                          parseFloat(metricsRow["Landslide"]) *
                                          100
                                        ).toFixed(2)}
                                        %
                                      </TableCell>
        ...
        <Grid item md={8} sm={12} sx={{ pl: 4, pb: 1 }}>
          <Paper sx={{ borderRadius: "10px", boxShadow: 2, height: "auto" }}>
            ...
            {["image_1", "image_2", "image_3"].map((content, i) => {
              return (
