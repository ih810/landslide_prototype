...
export default function ViewResult(){
  ...
  console.log('huh', targetCoordSus)
    return (
        <>
                ...
                <Grid container sx={{ ml:3 }} >
                    <Grid item xs={7}>
                        <Paper className='p-4' sx={{borderRadius:'10px', boxShadow:3}}>
                            <h3 className='p-3' style={{ fontWeight:650 }}>SUSCEPTIBILITY MAP</h3>
                            <OlMap viewLayer={viewLayer} layersGroup={layersGroup} setCoord={setCoord}/>
                        </Paper>
                    </Grid>
                    <Grid item xs={5}> 
                        <Grid container>
